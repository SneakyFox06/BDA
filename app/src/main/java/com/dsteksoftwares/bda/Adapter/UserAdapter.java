package com.dsteksoftwares.bda.Adapter;
...
import com.dsteksoftwares.bda.Email.JavaMailApi;
import com.dsteksoftwares.bda.Model.User;
import com.dsteksoftwares.bda.R;
                            ...
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                reference.addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        //below shows details of the person we send the email

                                        String mEmail = user.getEmail();
                                        String mSubject = "BLOOD DONATION";
                                        String mMessage = "Hello " + nameOfTheReceiver + ", " + nameOfSender +
                                                "would like a blood donation from you. Here's his/her details:\n" +
                                                "Name: " + nameOfSender + "\n" +
                                                "Phone Number: " + phone + "\n" +
                                                "Email: " + email + "\n" +
                                                "Blood Group: " + blood + "\n" +
                                                "Kindly reach out to him/her. Thank you!\n" +
                                                "LIFE SHARE - DONATE BLOOD, SAVE LIVES!";
